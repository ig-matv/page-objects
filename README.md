...
A ideia principal foi estruturar os testes de forma mais organizada, separando as interações e validações em arquivos específicos de cada página, como login e cadastro. Com isso, evitei repetição de código e deixei os testes mais limpos e fáceis de manter.
